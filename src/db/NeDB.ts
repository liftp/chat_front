...
import { ApplyFriend, ChatRecord, FriendList, FriendRelationship, GroupMember } from './model/models'
...
export const dbGroupMember: Datastore<GroupMember> = new Datastore<GroupMember>({
    filename: './groupMemberDB.db',
    autoload: true,
    // inMemoryOnly: false, // 是否仅存在内存中
    // timestampData: false, // 是属于creaedAt标记所有文档的插入和最后更新时间updatedAt
})
